<template>
	<view @click="hideShow">
		<!-- tab栏 -->
		<view class="tab_one">
			<view class="tab_list_one" v-for="(item,index) in items_list" :key="index" :class="{btna_list:count_list == index}" @click="changeList(index)">
				<view>{{item}}</view>
			</view>
		</view>
		<view class="tab">
