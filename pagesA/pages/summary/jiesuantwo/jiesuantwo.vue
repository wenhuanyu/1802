	...
	export default {
		...
		onLoad(option) {
			...
			uni.setNavigationBarTitle({
				title: this.option.emplo_name+'-'+this.option.quartel_name
			});
			this.listInterface()
		},
		mounted() {	
		...
		methods: {
			...
			tiaozhuan(eve) {
				uni.navigateTo({
					url:'/pagesA/pages/summary/jiesuanDetailTwo/jiesuanDetailTwo?data='+encodeURIComponent(JSON.stringify(eve))
				})
			}
		}
	}
